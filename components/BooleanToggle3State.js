...
const BooleanToggle3State = ({ value, controlled, onChange, positiveTxt, naText, negativeTxt, disabled, colors }) => {
    ...
    return (
        val === 'true' ? (
            <ButtonGroup size='small' appearance='outline' status='control'>
                ...
                <Button onPress={() => changeValue('na')} style={{ backgroundColor: neutralTxtColorBg || '#EAEAEC' }}><Text style={{ ...styles.bold, color: neutralTxtColorFg || '#000000' }}>{naText || 'N/A'}</Text></Button>
            </ButtonGroup>
        ) : val === 'false' ? (
            <ButtonGroup size='small' appearance='outline' status='control'>
            ...
            <ButtonGroup size='small' appearance='outline' status='control'>
                <Button onPress={() => changeValue('true')} style={{ backgroundColor: neutralTxtColorBg || '#EAEAEC' }}><Text style={{ ...styles.bold, color: neutralTxtColorFg || '#000000' }}>{positiveTxt || 'Sí'}</Text></Button>
                <Button onPress={() => changeValue('false')} style={{ backgroundColor: neutralTxtColorBg || '#EAEAEC' }}><Text style={{ ...styles.bold, color: neutralTxtColorFg || '#000000' }}>{naText || 'No'}</Text></Button>
                <Button onPress={() => changeValue('na')} style={{ backgroundColor: naTxtColorBg || '#F5B7BC' }}><Text style={{ ...styles.bold, color: naTxtColorFg || '#331B1D' }}>{naText || 'N/A'}</Text></Button>
            </ButtonGroup>
        ) : (
            <ButtonGroup size='small' appearance='outline' status='control'>
                <Button onPress={() => changeValue('true')} style={{ backgroundColor: neutralTxtColorBg || '#EAEAEC' }}><Text style={{ ...styles.bold, color: neutralTxtColorFg || '#000000' }}>{positiveTxt || 'Sí'}</Text></Button>
